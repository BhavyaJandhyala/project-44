...
function draw(){
    ...
    textSize(40);
        ...
        fill("black");
        textSize(40);
        text("Press 'SPACE' to start the game! Enjoy!",displayWidth/3.5,displayHeight/3+270);
    ...
    frequency=Math.round(random(30,50))
    ...
    if(score>=1500){
       ...
       strokeWeight(5);
       textSize(30);
       text("Press 'R' to restart the game ",450,270);
